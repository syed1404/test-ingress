# 1  Setting up IAM Users
Here's a step-by-step guide to creating and setting up IAM users:
...
### 1.2 Access Keys (for Programmatic Access):
...
### 2.2 Configuring AWS CLI Credentials:
...
### 2.4Configuring kubectl for EKS:
...
```
# 3 How to setup alb add on

### 3.1 Create IAM policy
- Save as im_policy.json
```json
{
    "Version": "2012-10-17",
    "Statement": [
